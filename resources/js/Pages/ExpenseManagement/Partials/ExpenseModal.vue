            ...
            >
                ...
                <div class="px-6 py-6 bg-white">
                    <div class="space-y-6">
                                ...
                                <input
                                    ...
                                    :class="{
                                        'border-red-400 focus:border-red-500 focus:ring-red-200':
                                            isSubmitted && !expenseForm.reason,
                                    }"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    :class="{
                                        'border-red-400 focus:border-red-500 focus:ring-red-200':
                                            isSubmitted && !expenseForm.amount,
                                    }"
                            ...
                            <p
                                v-if="isSubmitted && !expenseForm.amount"
                                class="mt-2 text-sm text-red-600"
                            >
                        ...
                        <!-- Preview Section -->
                        <div
                            v-if="expenseForm.reason && expenseForm.amount"
...
const translations = {
    en: {
        ...
        enterDescription: "Enter expense description (optional)",
    ...
    bn: {
        ...
        enterDescription: "ব্যয়ের বিবরণ লিখুন (ঐচ্ছিক)",
...
const submit = () => {
    ...
    if (expenseForm.value.reason.trim() && expenseForm.value.amount) {
        isLoading.value = true;
        console.log("Form data:", expenseForm.value);
        emit("submit", { ...expenseForm.value });
