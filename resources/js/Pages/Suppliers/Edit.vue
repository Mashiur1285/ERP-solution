                ...
                <div class="space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    @input="clearFieldError('branch_name')"
                                />
                                <p
                                    v-if="formErrors.branch_name"
                                    class="mt-2 text-sm text-red-600 flex items-center"
                                >
                                    <svg
                                        class="w-4 h-4 mr-1"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    :class="{
                                        'border-red-400 focus:border-red-500 focus:ring-red-200':
                                            formErrors.emergency_phone_number,
                                    }"
                                    @input="
                                        clearFieldError(
                                ...
                                />
                                <p
                                    v-if="formErrors.emergency_phone_number"
                                    class="mt-2 text-sm text-red-600 flex items-center"
                                >
                                    <svg
                                        class="w-4 h-4 mr-1"
                    ...
                    >
                        <Link
                            ...
                            class="w-full sm:w-auto px-6 sm:px-8 py-3 border-2 border-gray-300 rounded-lg text-gray-700 font-semibold hover:bg-gray-50 hover:border-gray-400 transition-all duration-300 flex items-center justify-center space-x-2"
                        >
                            <svg
                                class="w-5 h-5"
                                fill="none"
                        ...
                        <button
                            @click="submitForm"
                            class="w-full sm:w-auto px-6 sm:px-8 py-3 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 focus:ring-4 focus:ring-indigo-200 transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
                            :disabled="isLoading"
                        >
                            <svg
                                v-if="isLoading"
...
const submitForm = () => {
    ...
    console.log("Updating supplier with data:", form.value);

    router.put(`/suppliers/${props.supplier.id}`, form.value, {
        onSuccess: () => {
            showToastWithType("Supplier updated successfully!", "success");
            setTimeout(() => {
        ...
        onError: (errors) => {
            ...
            showToastWithType(
                "Failed to update supplier. Please check the form.",
                "error"
            );
        },
        onFinish: () => {
...
console.log("Edit.vue component loaded");
</script>
