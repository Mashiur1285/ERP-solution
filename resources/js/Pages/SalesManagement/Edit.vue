                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    :class="{
                                        'border-red-400 focus:border-red-500 focus:ring-red-200':
                                            shopForm.errors?.owner_name,
                                    }"
                                    @input="
                                        shopForm.clearErrors?.('owner_name')
                                    "
                                />
                                <p
                                    v-if="shopForm.errors?.owner_name"
                                    class="mt-2 text-sm text-red-600 flex items-center"
                                >
                                    <svg
                                        class="w-4 h-4 mr-1"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    @input="
                                        shopForm.clearErrors?.('phone_number')
                                    "
                                />
                                <p
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    :class="{
                                        'border-red-400 focus:border-red-500 focus:ring-red-200':
                                            shopForm.errors?.email,
                                    }"
                                    @input="shopForm.clearErrors?.('email')"
                                />
                                <p
                                    v-if="shopForm.errors?.email"
                                    class="mt-2 text-sm text-red-600 flex items-center"
                                >
                                    <svg
                                        class="w-4 h-4 mr-1"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    :class="{
                                        'border-red-400 focus:border-red-500 focus:ring-red-200':
                                            shopForm.errors?.website,
                                    }"
                                    @input="shopForm.clearErrors?.('website')"
                                />
                                <p
                                    v-if="shopForm.errors?.website"
                                    class="mt-2 text-sm text-red-600 flex items-center"
                                >
                                    <svg
                                        class="w-4 h-4 mr-1"
                    ...
                    >
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input
                                    ...
                                    :class="{
                                        'border-red-400 focus:border-red-500 focus:ring-red-200':
                                            shopForm.errors?.shop_address,
                                    }"
                                    @input="
                                        shopForm.clearErrors?.('shop_address')
                                    "
                                />
                                <p
                                    v-if="shopForm.errors?.shop_address"
                                    class="mt-2 text-sm text-red-600 flex items-center"
                                >
                                    <svg
                                        class="w-4 h-4 mr-1"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    :class="{
                                        'border-red-400 focus:border-red-500 focus:ring-red-200':
                                            shopForm.errors?.national_id,
                                    }"
                                    @input="
                                        shopForm.clearErrors?.('national_id')
                                    "
                                />
                                <p
                                    v-if="shopForm.errors?.national_id"
                                    class="mt-2 text-sm text-red-600 flex items-center"
                                >
                                    <svg
                                        class="w-4 h-4 mr-1"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    :class="{
                                        'border-red-400 focus:border-red-500 focus:ring-red-200':
                                            shopForm.errors?.trade_license,
                                    }"
                                    @input="
                                        shopForm.clearErrors?.('trade_license')
                                    "
                                />
                                <p
                                    v-if="shopForm.errors?.trade_license"
                                    class="mt-2 text-sm text-red-600 flex items-center"
                                >
                                    <svg
                                        class="w-4 h-4 mr-1"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    :class="{
                                        'border-red-400 focus:border-red-500 focus:ring-red-200':
                                            shopForm.errors?.tax_id,
                                    }"
                                    @input="shopForm.clearErrors?.('tax_id')"
                                />
                                <p
                                    v-if="shopForm.errors?.tax_id"
                                    class="mt-2 text-sm text-red-600 flex items-center"
                                >
                                    <svg
                                        class="w-4 h-4 mr-1"
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                :class="{
                                    'border-red-400 focus:border-red-500 focus:ring-red-200':
                                        shopForm.errors?.notes,
                                }"
                                rows="4"
                                @input="shopForm.clearErrors?.('notes')"
                            ></textarea>
                            <p
                                v-if="shopForm.errors?.notes"
                                class="mt-2 text-sm text-red-600 flex items-center"
                            >
                                <svg
                                    class="w-4 h-4 mr-1"
...
const shopForm = useForm<Shop>({
    id: props.shop.id,
    shop_name: props.shop.shop_name,
    road: props.shop.road,
    ...
    national_id: props.shop.national_id,
    trade_license: props.shop.trade_license,
    tax_id: props.shop.tax_id,
    notes: props.shop.notes,
});
...
const updateShop = () => {
    ...
    shopForm.put(`/shops/${props.shop.id}`, {
        onSuccess: () => {
            showToastWithType("Shop Updated Successfully", "success");
        },
        onError: (errors: Record<string, string>) => {
            console.error("Shop update errors:", errors);
            showToastWithType(
                "Failed to update shop. Please check the form.",
                "error"
            );
        },
    });
